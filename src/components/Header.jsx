...
function Header() {
  ...
  return (
    <header className="flex justify-center">
      ...
      <nav
        className={`${isMenuOpen ? "block" : "hidden"} sm:block fixed top-24 bottom-2 w-11/12 sm:bottom-auto sm:top-3 sm:w-auto bg-slate-100/50 px-5 py-2 z-50 rounded-2xl sm:rounded-full backdrop-blur-md sm:backdrop-blur-sm drop-shadow-sm border border-b-0 border-slate-50/50 dark:bg-neutral-800/50 dark:border-slate-50/20`}>
