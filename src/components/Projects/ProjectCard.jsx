...
function ProjectCard({project}) {
  ...
  return (
      <motion.div
        className="w-full flex flex-col gap-2 border border-gray-300 rounded-sm text-gray-800 md:flex-row md:h-72 dark:border-neutral-700 dark:bg-neutral-800"
      ...
      >
        ...
        <div className="w-full flex flex-col p-6 gap-3 dark:text-gray-300">
